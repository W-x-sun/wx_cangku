...
struct Triangle {
    Triangle(glm::vec3 v1, glm::vec3 v2, glm::vec3 v3,   //三角形的三个顶点
             glm::vec2 uv1, glm::vec2 uv2, glm::vec2 uv3,  //对应的纹理坐标
             glm::vec3 n1, glm::vec3 n2, glm::vec3 n3) :  //对应的法向量
...
//在三角形中生成随机点、随机点对应的uv和normal
    void randPoint(glm::vec3 &pos, glm::vec2 &uv, glm::vec3 &normal,int &_face_)
    {
